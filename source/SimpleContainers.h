...
private:
  ...
  node* nodeAlloc() {
    ...
    if (nextNodePtr - allocationBlockPtrs.back() > allocationBlockSize * paddedNodeSize) {
...
public:
  void* allocate(size_t size, size_t alignment) {
    ...
    if (nextNodePtr - allocationBlockPtrs.back() > allocationBlockSize) {
...
class SimpleSet {
private:
  SimpleAlloc* alloc;  // pointer to the memory allocator
